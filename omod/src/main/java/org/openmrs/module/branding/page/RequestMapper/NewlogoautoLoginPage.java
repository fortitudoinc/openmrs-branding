 ...
 */
package org.openmrs.module.branding.page.RequestMapper;
 ...
 */
@Component
public class NewlogoautoLoginPage implements PageRequestMapper {
	...
	public boolean mapRequest(PageRequest request) {
		System.out.println("NewlogoautoLoginPage: " + request.getProviderName() + "  PAGE: " + request.getPageName());
